...
The project is hosted on [https://github.com/whiteprints-tests/test-rtd-darwin-py39-test.git](https://github.com/whiteprints-tests/test-rtd-darwin-py39-test.git).
